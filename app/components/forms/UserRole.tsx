...
const ChooseRole = () => {
  ...
  return (
    <div className=" min-h-screen h-full flex overflow-hidden bg-white p-5 lg:p-0">
      <div className="w-full flex">
        ...
        <div className="w-full h-full overflow-hidden lg:w-1/2 flex pt-20 justify-center items-center">
          <div className=" md:max-w-[600px] lg:max-w-[500px] xl:max-w-[500px] 2xl:max-w-[650px] w-full ">
            ...
            <AnimatePresence custom={1} mode="wait">
              ...
              >
                {/* Account  Card  */}
                <div className=" md:max-w-[600px] lg:max-w-[500px] xl:max-w-[500px] 2xl:max-w-[650px] w-full mx-auto">
                  <button className="w-full" onClick={() => handlerIsActive("owner")}>
                    <Account
                      icon={
                        <svg
                          width="18"
                  ...
                  <div className="mt-4">
                    <button className="w-full" onClick={() => handlerIsActive("investor")}>
                      <Account
                        icon={
                          <svg
                            width="18"
                  ...
                  <div className="mt-3  text-[16px]  md:text-[18px] leading-[27px]">
                    <p className="text-color2">
                      Company not listed yet?{" "}
                      <a href="#" className="px-2 text-primaryColor hover:underline">
            ...
            <div className="flex gap-4 pt-[30px]">
              <Button onClick={handlerBack} type="button" variant="secondary">
                Back
              </Button>
