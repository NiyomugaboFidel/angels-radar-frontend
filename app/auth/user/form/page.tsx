...
import Account from "@/app/components/common/AccountCard";
          ...
          <div className="max-w-[427px] w-full">
            ...
            <AnimatePresence custom={direction} mode="wait">
              <motion.div
                ...
                className="relative"
              >
                <Forms handlerIsActive={handlerIsActive} isActive={isActive} page={currentPage} />
              </motion.div>
            </AnimatePresence>
...
export const Forms: React.FC<{
  page: number;
  isActive:string
  handlerIsActive:(role:string) => void
}> = ({ page, isActive, handlerIsActive }) => {
  switch (page) {
